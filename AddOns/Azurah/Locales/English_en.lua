...
L.Usage									= "|c67b1e9A|c4779cezurah|r - Usage:\n|cffc600  /azurah unlock|r |cffffff =  unlock UI for movement|r\n|cffc600  /azurah save|r |cffffff =  lock UI and save positions|r\n|cffc600  /azurah undo|r |cffffff =  undo all pending changes|r\n|cffc600  /azurah exit|r |cffffff =  lock UI without saving|r"
	...
	L.TheftBlocked							= "|c67b1e9A|c4779cezurah|r - Theft was prevented due to your settings."
...
-- move window names
	...
	L.DialogueWindow						= "Dialogue Window"
...
-- settings: general tab (1)
	...
	L.General_TheftPreventTip				= "Set whether to prevent the looting of owned items on display in the world. This includes all those armor pieces, weapons, food etc. that would give a bounty if caught taking.\n\nPlease note that this provides no protection against looting containers."
	L.General_TheftSafer					= "Safer Theft of World Items"
	L.General_TheftSaferTip					= "Set whether to re-enable the theft of owned items when fully hidden.\n\nPlease note that this still provides no protection against looting containers."
	L.General_CTheftSafer					= "Safer Theft from Containers"
	L.General_CTheftSaferTip				= "Set whether to prevent opening owned containers unless fully hidden."
	L.General_PTheftSafer					= "Safer Pickpocketing"
	L.General_PTheftSaferTip				= "Set whether to make pickpocketing safer by preventing looting unless fully hidden."
	L.General_TheftSaferWarn				= "This is technically cheating!"
	L.General_TheftAnnounceBlock			= "Announce When A Theft Is Prevented"
	L.General_TheftAnnounceBlockTip			= "Set whether to announce when an attempted theft is blocked by your Thievery settings.\n\nThe alert will got to the current chat window."
	...
	L.General_ATrackerDisableTip			= "Disables the status display for activities such as the Dungeon Finder and Battlgrounds."
