...
tabPanelData = {
	...
	[1] = {
		...
		{
			type = 'checkbox',
			name = L.General_CTheftSafer,
			tooltip = L.General_CTheftSaferTip,
			warning = L.General_TheftSaferWarn,
			getFunc = function()
				return Azurah.db.theftCMakeSafer
			end,
			setFunc = function(v)
				Azurah.db.theftCMakeSafer = v
				Azurah:ConfigureThievery()
			end,
		},
		{
			type = 'checkbox',
			name = L.General_PTheftSafer,
			tooltip = L.General_PTheftSaferTip,
			warning = L.General_TheftSaferWarn,
			getFunc = function()
				return Azurah.db.theftPMakeSafer
			end,
			setFunc = function(v)
				Azurah.db.theftPMakeSafer = v
				Azurah:ConfigureThievery()
			end,
		},
		{
			type = 'checkbox',
			name = L.General_TheftAnnounceBlock,
			tooltip = L.General_TheftAnnounceBlockTip,
			getFunc = function()
				return Azurah.db.theftAnnounceBlock
			end,
			setFunc = function(v)
				Azurah.db.theftAnnounceBlock = v
				Azurah:ConfigureThievery()
			end,
		},
		-- -----------------------
