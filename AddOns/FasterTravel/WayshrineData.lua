...
local _zoneNodeLookup = {
    ...
    [ 19] = { -- Shadowfen
        ...
        { poiIndex = 30, nodeIndex = 78,  name = "Venomous Fens Wayshrine" },
    ...
    [744] = { -- Blackreach: Greymoor Caverns
    ...
    [783] = { -- Blackreach: Arkthzand Cavern
    ...
    [853] = { -- Fargrave
		...
		{ poiIndex = 5, nodeIndex = 493, name = "Fargrave Wayshrine", },
