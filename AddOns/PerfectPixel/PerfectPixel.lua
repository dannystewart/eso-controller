...
--FIX market scene
	local tabMarketScenes = {"market", "esoPlusOffersSceneKeyboard", "dailyLoginRewards", "giftInventoryKeyboard"}
...
KEYBIND_STRIP_STANDARD_STYLE.rightAnchorOffset	= -10
